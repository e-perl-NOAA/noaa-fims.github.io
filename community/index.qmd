...
# The public iCal link for your specific Google Calendar
...
tryCatch({
  ...
  if(nrow(next_event) > 0) {
    ...
    <div class="fims-meeting-card">
      ...
      <button onclick="window.location.href='https://calendar.google.com/calendar/u/0?cid=Y182ZWx1djFoOG84MzBrN3Z0OGN0Y3M2Z2h0b0Bncm91cC5jYWxlbmRhci5nb29nbGUuY29t'" class="btn btn-light fims-btn-full">Add to calendar
      </button>
    </div>
    ')

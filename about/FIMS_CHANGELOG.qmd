...
## v0.10.0 ([release notes](https://github.com/NOAA-FIMS/FIMS/releases/tag/v0.10.0))
### What's Changed
- Use `setup_default_parameters()` to set up a model
- Specify uncertainty in the input data frame using a formula with a distribution and arguments
